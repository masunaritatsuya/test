...
public class BuyItemCompleteDAO {
    ...
    private String sql="INSERT INTO user_buy_item_transaction(item_transaction_id,toral_price,total_price,total_count,user_master_id,pay,insert_date)VALUES(?,?,?,?,?,?)";
